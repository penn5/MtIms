...
class MtRadioIndicationV2_0(val mSlotId: Int) : vendor.mediatek.hardware.radio.V2_0.IRadioIndication.Stub() {
    ...
    override fun onPdnHandover(p0: Int, p1: ArrayList<Int>?) {
    }
    ...
    override fun onWfcPdnError(p0: Int, p1: ArrayList<Int>?) {
    }
    ...
    override fun onLocationRequest(p0: Int, p1: ArrayList<String>?) {
    }
    ...
    override fun onNattKeepAliveChanged(p0: Int, p1: ArrayList<String>?) {
    }
    ...
    override fun onWifiMonitoringThreshouldChanged(p0: Int, p1: ArrayList<Int>?) {
    }
    ...
    override fun onWfcPdnStateChanged(p0: Int, p1: ArrayList<Int>?) {
    }
    ...
    override fun onWifiPdnActivate(p0: Int, p1: ArrayList<Int>?) {
    }
    ...
    override fun onWifiRoveout(p0: Int, p1: ArrayList<String>?) {
    }
