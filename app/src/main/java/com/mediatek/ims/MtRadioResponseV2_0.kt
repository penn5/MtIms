...
import vendor.mediatek.hardware.radio.V2_0.*
import java.util.*

// Useful for AT commands only

class MtRadioResponseV2_0(val mSlotId: Int) : vendor.mediatek.hardware.radio.V2_0.IRadioResponse.Stub() {
    ...
    override fun setWifiIpAddressResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setWifiEnabledResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setWifiAssociatedResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setNattKeepAliveStatusResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setEmergencyAddressIdResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setWifiSignalLevelResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setLocationInfoResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
