...
import android.hardware.radio.V1_2.*
...
class MtImsRadioIndicationV3_0(private val mSlotId: Int) : IImsRadioIndication.Stub() {
    override fun imsCfgDynamicImsSwitchComplete(p0: Int) {
        Rlog.v(tag, "imsCfgDynamicImsSwitchComplete($p0)")
    }
    ...
    override fun onVolteSubscription(p0: Int, p1: Int) {
        Rlog.v(tag, "onVolteSubscription($p0, $p1)")
    }

    override fun imsCfgConfigLoaded(p0: Int) {
        Rlog.v(tag, "imsCfgConfigLoaded($p0)")
    }

    override fun imsCfgConfigChanged(p0: Int, p1: Int, p2: String?, p3: String?) {
        Rlog.v(tag, "imsCfgConfigChanged($p0, $p1, $p2, $p3)")
    }

    override fun speechCodecInfoIndication(p0: Int, p1: Int) {
        Rlog.v(tag, "speechCodecInfoIndication($p0, $p1)")
    }

    override fun imsRadioInfoChange(p0: Int, p1: String?, p2: String?) {
        Rlog.v(tag, "imsRadioInfoChange($p0, $p1, $p2)")
    }

    override fun newSmsEx(p0: Int, p1: java.util.ArrayList<Byte>?) {
        Rlog.v(tag, "newSmsEx($p0, $p1)")
    }

    override fun networkScanResult(p0: Int, p1: android.hardware.radio.V1_1.NetworkScanResult?) {
        Rlog.v(tag, "networkScanResult($p0, $p1)")
    }

    override fun currentSignalStrength_1_2(p0: Int, p1: SignalStrength?) {
        Rlog.v(tag, "currentSignalStrength_1_2($p0, $p1)")
    }

    override fun networkScanResult_1_2(p0: Int, p1: NetworkScanResult?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun newSmsStatusReportEx(p0: Int, p1: java.util.ArrayList<Byte>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun imsConferenceInfoIndication(p0: Int, p1: java.util.ArrayList<ImsConfParticipant>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun lteMessageWaitingIndication(p0: Int, p1: String?, p2: String?, p3: String?, p4: String?, p5: String?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun imsDialogIndication(p0: Int, p1: java.util.ArrayList<Dialog>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun cdmaNewSmsEx(p0: Int, p1: CdmaSmsMessage?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun cellInfoList(p0: Int, p1: java.util.ArrayList<android.hardware.radio.V1_0.CellInfo>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun currentPhysicalChannelConfigs(p0: Int, p1: java.util.ArrayList<PhysicalChannelConfig>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun imsCfgFeatureChanged(p0: Int, p1: Int, p2: Int, p3: Int) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun cellInfoList_1_2(p0: Int, p1: java.util.ArrayList<CellInfo>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun imsDataInfoNotify(p0: Int, p1: String?, p2: String?, p3: String?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    override fun imsEnableStart(p0: Int) {
        ...
        MtImsService.instance!!.getRegistration(mSlotId).imsEnableStart()
    }
    ...
    companion object {
        const val tag = "MtImsRadioIndicationV3_0"
    }
