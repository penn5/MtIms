...
// Useful for AT commands only

class MtRadioResponseV3_0(val mSlotId: Int) : vendor.mediatek.hardware.radio.V3_0.IRadioResponse.Stub() {
    ...
    override fun sendRequestStringsResponse(p0: RadioResponseInfo?, p1: ArrayList<String>?) {
        onResponse(p0, p1)
        Rlog.e(tag, "GOT AT CMD RESP")
    }
    ...
    override fun reportAirplaneModeResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getSuppServPropertyResponse(p0: RadioResponseInfo?, p1: String?) {
        onResponse(p0)
    }
    ...
    override fun supplyDepersonalizationResponse(p0: RadioResponseInfo?, p1: Int) {
        onResponse(p0)
    }
    ...
    override fun setOverrideApnResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun dataConnectionAttachResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }

    override fun setVoicePreferStatusResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun resetAllConnectionsResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setEccNumResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setE911StateResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getCurrentCallsResponse_1_2(p0: RadioResponseInfo?, p1: ArrayList<android.hardware.radio.V1_2.Call>?) {
        onResponse(p0)
    }

    override fun sendRequestRawResponse(p0: RadioResponseInfo?, p1: ArrayList<Byte>?) {
        onResponse(p0)
    }

    override fun setPdnReuseResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun supplyDeviceNetworkDepersonalizationResponse(p0: RadioResponseInfo?, p1: Int) {
        onResponse(p0)
    }
    ...
    override fun getIccCardStatusResponse_1_2(p0: RadioResponseInfo?, p1: android.hardware.radio.V1_2.CardStatus?) {
        onResponse(p0)
    }
    ...
    override fun setSilentRebootResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getEccNumResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setPropImsHandoverResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }

    override fun getSignalStrengthResponse_1_2(
        p0: RadioResponseInfo?,
        p1: android.hardware.radio.V1_2.SignalStrength?
    ) {
        onResponse(p0)
    }
    ...
    override fun getCellInfoListResponse_1_2(
        p0: RadioResponseInfo?,
        p1: ArrayList<android.hardware.radio.V1_2.CellInfo>?
    ) {
        onResponse(p0)
    }
    ...
    override fun getVoiceRegistrationStateResponse_1_2(
        p0: RadioResponseInfo?,
        p1: android.hardware.radio.V1_2.VoiceRegStateResult?
    ) {
        onResponse(p0)
    }

    override fun setServiceStateToModemResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getDataRegistrationStateResponse_1_2(
        p0: RadioResponseInfo?,
        p1: android.hardware.radio.V1_2.DataRegStateResult?
    ) {
        onResponse(p0)
    }

    override fun setPdnNameReuseResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setSuppServPropertyResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setSmsFwkReadyRsp(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setTxPowerStatusResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setOperatorConfigurationResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun dataConnectionDetachResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getLteReleaseVersionResponse(p0: RadioResponseInfo?, p1: Int) {
        onResponse(p0)
    }
    ...
    override fun setPhonebookReadyResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun reportSimModeResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun setLteReleaseVersionResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getIccidResponse(p0: RadioResponseInfo?, p1: String?) {
        onResponse(p0)
    }
    ...
    override fun restartRILDResponse(p0: RadioResponseInfo?) {
        onResponse(p0)
    }
    ...
    override fun getSignalStrengthWithWcdmaEcioResponse(p0: RadioResponseInfo?, p1: SignalStrengthWithWcdmaEcio?) {
        onResponse(p0)
    }
